...
// 2. Description: Create a class Student with fields name and averageGrade. Implement the Comparable<Student> interface to sort students in descending order by averageGrade. Use Collections.sort().
