...
public class MainWeek03 {
    public static void main(String[] args){
        ...
        Set<Ex01BookComparer> books = new HashSet<>(Arrays.asList(
    ...
    Stream.of(new Ex02Student("Tom Smith", 4.22),
            new Ex02Student("Kate Williams", 3.98),
            new Ex02Student("Peter Johnson", 4.82),
            new Ex02Student("Sam Potter", 3.59)).sorted().forEach(System.out::print);
